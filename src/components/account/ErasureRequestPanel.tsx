  ...
  return (
    <section aria-label="Приватность и удаление аккаунта" style={{ maxWidth: '620px' }}>
      ...
      <p style={{ color: '#666', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '1rem' }}>
        ...
        Аккаунт остаётся доступным для входа ещё 30 дней — этого времени достаточно, чтобы отменить запрос,
        если вы передумаете. По истечении срока данные обезличиваются автоматически.
      </p>
